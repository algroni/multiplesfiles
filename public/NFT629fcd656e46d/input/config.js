      ...
      const height = 4000;
      const dir = __dirname;
      const name = "Collection june";
      const description = "Collection June";
      const wallet = "";
      const hash = "629fcd656e46d";
      const royalty = 0;
      const baseImageUri = "http://multiple-files.test/NFT629fcd656e46d/output";
