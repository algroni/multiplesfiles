      ...
      const height = 3000;
      const dir = __dirname;
      const name = "240322 Collection 5";
      const description = "";
      const wallet = "";
      const hash = "623bd281077de";
      const royalty = 0;
      const baseImageUri = "http://multiple-files.test/NFT623bd281077de/output";
      const startEditionFrom = 1;
      const endEditionAt =300;
      const editionSize =300;
      const raceWeights = [
        {
          value: "skull",
          from: 1,
