...
<!--
    ...
    <h3>Email</h3>
    <div>
      <input type="text" value="" size="80" id="email" name="email" >
    </div>

    <h3>Password</h3>
    <div>
      <input type="password" value="" size="80" id="pass" name="pass" >
    </div>
        ...
        <div class="container">
          <div class="col col-md-9 col-lg-7 mx-auto">
            <div class="member-login-header">
              <h1><em>Member</em> Login</h1>
              <p>Welcome back! Sign in to your account</p>
            </div>
            <div class="form-wrap">
              <form class="row" method="post" action="{{ route('login.start') }}">
              @csrf
                <div class="col-sm-6 form-control-grp">
                  ...
                  <!-- <span class="f-invalid">Error message display here.</span>
                  -->
                </div>
                <div class="col-sm-6 form-control-grp">
                  <label for="loginPassword" class="form-label">Password<span class="required">*</span></label>
                  <input type="password" class="form-control" id="pass" name="pass" placeholder="Enter here" required>
                </div>
                ...
                <div class="col text-center form-control-grp">
                  ...
                  -->
                  <p>Don't have an Account? <a href="#" title="Register User" class="link">Register User</a></p>
                </div>
